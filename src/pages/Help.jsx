    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-600 to-blue-500 p-10 font-sans">
            <div className="max-w-md mx-auto">
                ...
                <div className="bg-white/20 backdrop-blur-md rounded-xl p-6 space-y-2 text-white">
                    <p>
                    ...
                    <h3 className="text-2xl font-bold text-center text-yellow-300 py-3">¡Diviértete y aprende jugando!</h3>
                </div>
            </div>
        </div>
    )
