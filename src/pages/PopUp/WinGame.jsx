    ...
    return (
        <div className="py-7 px-7 h-screen">
            <div className="bg-gray-400 h-full rounded-md max-w-md mx-auto px-4 py-10 flex flex-col items-center justify-around space-y-4">
                ...
                <h1 className="text-cyan-950 text-3xl font-semibold">¡Wow... Ganaste!</h1>
                <p className="text-cyan-950 text-lg text-center">Felicitaciones, has podido completar el juego</p>
                </div>
